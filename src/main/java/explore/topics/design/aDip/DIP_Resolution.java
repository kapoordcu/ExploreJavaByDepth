...
class BackEndDeveloper_1 implements Developer {
    ...
    public void writeJava() {
        System.out.println("Java 8 code written by: " + explore.topics.design.aDip.BackEndDeveloper.class.getName());
    }
}
...
class FrontEndDeveloper_1 implements Developer {
    ...
    public void writeJavaScript() {
        System.out.println("javascript code written by: " + explore.topics.design.aDip.FrontEndDeveloper.class.getName());
    }
}
