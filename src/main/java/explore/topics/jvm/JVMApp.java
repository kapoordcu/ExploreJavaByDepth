...
/*
    ...
    Specification and Implementation
        ...
        Runtime Instance (When you run a java program , a jvm instance is created and loaded into memory, JVM then loads the program into memory and executes) - Runs only 1 java application
    Performance
        Java Bytecode is compact, compiled(syntax and semantics check already done) and optimized
        JIT compilation  ---> Dynamic Compilation (Not defined in JVM specs, but in concrete implementation)
